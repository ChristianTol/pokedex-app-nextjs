...
const Strategy = ({ pokemonDetails }) => {
  ...
  const PokemonDisplay = ({ pokemonDetails }) => (
    <div className="mb-6 text-white p-4 text-center shadow-md w-[325px] md:w-[400px] mx-auto" style={{ background: 'rgba(0, 0, 0, 0.2)', borderRadius: '1rem' }}>
  ...
  return (
    <div className="strategy-container ">
      ...
      <div className="mb-2 text-white p-4 shadow-md w-[325px] md:w-[500px] mx-auto" style={{ background: 'rgba(0, 0, 0, 0.2)', borderRadius: '1rem' }}>
